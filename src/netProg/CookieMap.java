...
//               bu.setVisible(false);
   ...
   public void Die() {
      if(die==true) {
         ...
         JOptionPane.showMessageDialog(null, "寃뚯엫 �걹!");
         die=false;
         dispose();
...
//      System.out.println("�뭾�꽑 �쐞移� bx : " + bx);
//      System.out.println("�뭾�꽑 �쐞移� by : " + by);
   ...
   Runnable runnable = new Runnable() {
      ...
      public void run() {
         while (true) {
            ...
            repaint();
            try {
               Thread.sleep(speed);// 理쒓퀬 �씠�룞�냽�룄�뒗 40�쑝濡� �꽕�젙
            } catch (InterruptedException e) {
               e.printStackTrace();
            }
         }
